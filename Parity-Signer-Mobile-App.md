...
Please double check carefully the origin of the App, and make sure that the company distributing it is **Parity Technologies**. The usual security advices apply to this air-gapped wallet: 
...
- Make sure to first transfer small amount of Ether with the App and verify that everything is working as expected before transfering large amount of Ether.
